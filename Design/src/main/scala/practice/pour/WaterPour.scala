package practice.pour

class Pour(capacity: Vector[Int]) {
...
object WaterPour extends App {

  var problem = new Pour(Vector(4, 9))
  //  println(problem.moves)

  //  println((problem.pathSets take 5).toList)

  println((problem solution 6 take 3).toList)
}
